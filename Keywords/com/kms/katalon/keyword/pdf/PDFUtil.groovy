...
public class PDFUtil {
	...
	@CompileStatic
	@Keyword
	public boolean compareByPixcel(String file1, String file2,int startPage, int endPage, boolean highlightImageDifferences, boolean showAllDifferences) throws IOException{
